...
function web_mandelbrot(env) {
    ...
    //function make_base(contextI)
    //{
    //    base_image = new Image();
    //    base_image.src = 'imgs/player.png';
    //    base_image.onload = function(){
    //        contextI.drawImage(base_image, 0, 0);
    //    }     
    //}
    ...
    function move() {
        document.addEventListener("keypress", function(event) {
            if (event.keyCode == 39) {
                ...
                var yL=0;
                radius /= 1.1;
                pt = draw.mapped_point(xL+1, yL+1);
    ...
    function init() {
        ...
        //const noRightClick = document.getElementsByName("viewport");
        ...
        while (true) {
            ...
            imageObj.src = "imgs/player.png";    
            context.drawImage(imageObj, context.canvas.width * 0.3, context.canvas.height / 2, imageObj.width * 0.2, imageObj.height * 0.2)
        }
